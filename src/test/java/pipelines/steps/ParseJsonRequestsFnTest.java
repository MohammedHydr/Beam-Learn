...
public class ParseJsonRequestsFnTest extends TestCase {

    public void testProcessElement() throws Exception {
        DoFnTester<String, RequestJson> parseJsonRequestsFn = DoFnTester.of(new ParseJsonRequestsFn());
        RequestJson rj = new RequestJson("107.77.212.118","https://log.cognativex.com/pixel.png?kc=" +
        ...
        Assert.assertThat(
                parseJsonRequestsFn.processBundle(link),
                CoreMatchers.hasItems(rj));
    }
}